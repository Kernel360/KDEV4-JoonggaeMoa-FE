...
export const MAP_ZOOM_LEVELS = {
  ...
  MIN_FETCH: 1,         // 데이터 fetching 최소 줌 레벨
...
export const DISPLAY_MODE_BY_ZOOM_LEVEL = {
  1: MAP_DISPLAY_MODES.SHOW_CITY_COUNT,     // 1~2: 시별 매물 개수 표시 (가장 넓은 뷰)
  2: MAP_DISPLAY_MODES.SHOW_CITY_COUNT,     
  3: MAP_DISPLAY_MODES.SHOW_ALL_PINS,       // 3 이상: 개별 매물 핀 표시
  4: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  5: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  6: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  7: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  8: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  9: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  10: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  11: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  12: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  13: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  14: MAP_DISPLAY_MODES.SHOW_ALL_PINS
} as const;
