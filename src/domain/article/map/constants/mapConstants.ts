...
export const DISPLAY_MODE_BY_ZOOM_LEVEL = {
  1: MAP_DISPLAY_MODES.SHOW_ALL_PINS,     // 1~4: 모든 매물 핀 표시
  2: MAP_DISPLAY_MODES.SHOW_ALL_PINS,     
  3: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  4: MAP_DISPLAY_MODES.SHOW_ALL_PINS,
  5: MAP_DISPLAY_MODES.SHOW_CLUSTERS,     // 5~6: 클러스터 표시
  6: MAP_DISPLAY_MODES.SHOW_CLUSTERS,
  7: MAP_DISPLAY_MODES.SHOW_DISTRICT_COUNT, // 7~8: 구/군별 매물 개수 표시
  8: MAP_DISPLAY_MODES.SHOW_DISTRICT_COUNT,
  9: MAP_DISPLAY_MODES.SHOW_CITY_COUNT,   // 9 이상: 시/도별 매물 개수 표시
