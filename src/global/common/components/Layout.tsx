...
import Footer from '@/global/common/components/Footer';
                        ...
                        <List sx={{py: 1}}>
                            ...
                            <ListItem component="li" disablePadding>
                                ...
                                >
                                    <ListItemIcon sx={{minWidth: 40}}>
                                        <Business
                                            color={location.pathname.startsWith("/article") ? "primary" : "action"}/>
                                    </ListItemIcon>
                                    <ListItemText
                                        primary="매물 관리"
                                        primaryTypographyProps={{
                            ...
                            <ListItem component="li" disablePadding>
                                ...
                                >
                                    <ListItemIcon sx={{minWidth: 40}}>
                                        <Assignment
                                            color={location.pathname.startsWith("/survey") ? "primary" : "action"}/>
                                    </ListItemIcon>
                                    <ListItemText
                                        primary="설문 관리"
                                        primaryTypographyProps={{
